 ...
 * and untagged registrations are unclassifiable.
 *
 ...
 *     A reader who first arrived from a link-in-bio and later clicks the ad gets
 ...
 *     untagged registration still be classified by channel.
 *
 ...
 * be able to break a registration.
 */
...
/**
 * Read when the registration form is submitted.
 *
 * LIVE URL FIRST, then storage: a reader can land straight on /register with
