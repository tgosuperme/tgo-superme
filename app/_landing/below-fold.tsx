 ...
 *
 * COPY IS VERBATIM from that PDF, with ONE change running through every
 * section: THE CHALLENGE IS FREE. Prices became the word "Free", CTA labels
 * became "Claim My Free Place", and the money-back guarantee under each one
 * became the no-card line — a guarantee on something nobody pays for promises
 * nothing. Nothing else was re-voiced: it is the wording the UK compliance
 ...
 * savings badge, and any percentage outcome claim. Going free makes the second
 * one MORE tempting, not less — "was £4.99, now free" is the same device — so
 * it stays out.
 */
import {
  ArrowRight,
...
function Promise() {
  return (
    ...
    >
      {/* The promise, given the Sreshtha promise-band treatment: sealed
          ...
          The sentence itself changed shape when the offer went free. "Come to
          Day One, then decide" used to be underwritten by a refund; now it is
          underwritten by there having been nothing to pay in the first place,
          which is a stronger version of the same promise and needs no policy
          behind it. */}
      <m.div
        variants={fadeUp}
        initial="hidden"
      ...
      >
        ...
        >
          ...
          Brace Method for yourself. It is completely free, so there is nothing
          to weigh up and nothing to get back.
        </p>
...
const FAQS = [
  ...
  /* THE FIRST QUESTION A FREE OFFER CREATES, and the reason it leads the
     list. On the paid page the reader's opening objection was the price; take
     the price away and it becomes suspicion, which is a harder objection to
     leave unanswered. */
  {
    q: 'If it is free, what is the catch?',
    a: "There isn't one. You do not pay, you do not give us a card, and nothing turns into a subscription afterwards. On Day 5 we explain how to keep going with SuperMe if you want to, and you are under no obligation to. We would rather you experienced the method properly than argued with a price tag before you had.",
  },
  {
    q: 'My employer already gives me a free app for this. Why would I do this instead?',
    a: "Those apps are useful, but they're self-guided — nobody is watching how you move or correcting you in real time. This challenge is live, with a coach adjusting what you're doing as you're doing it. It's a different kind of support, not a replacement. It costs nothing either, so it is not a question of one or the other.",
  },
  {
  ...
  return (
    <section className="px-4 py-16 sm:py-24" style={{ background: C.white }}>
      <div className="mx-auto max-w-[1060px]">
        ...
        >
          <PrimaryCTA label="Hold my free place" />
  ...
  return (
    ...
    >
      ...
      {/* One sentence on desktop; two centred lines on a phone, split at the
          ...
          before the second half is dropped on mobile — a line that opens with a
      ...
      <p className="mx-auto max-w-[640px]">
        ...
        <span className="block sm:inline">
          {FREE_LABEL} to join, no card needed
        </span>
      </p>
