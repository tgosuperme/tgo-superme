 ...
 *
 * Copy is verbatim from the signed-off PDF, with one change running through
 * the whole page: THE CHALLENGE IS FREE. Every price has become the word
 * "Free", and the money-back guarantee under each CTA has become the no-card
 * line, because a guarantee on something nobody pays for is meaningless.
 *
 * Three devices from the reference page are deliberately absent and must stay
 * absent, because the UK rules this page was reviewed against forbid all
 * three: a rising-price line, a struck list price with a savings badge, and a
 * percentage outcome claim. Going free makes the second one more tempting, not
 * less — "normally £X, today free" is the same device wearing a hat — so it
 * stays out.
 */
import {
  ArrowRight,
...
export function OfferStrip() {
  return (
    ...
    >
      ...
      <span className="font-semibold">Now free:</span> the 5-Day Pain Reset
...
/* ── 1b. Site header ──────────────────────────────────────────────────────
   ...
   is a single-offer page and every link out of it is a way to not register. */
      ...
      <div className="mx-auto grid max-w-[1180px] items-center gap-12 px-5 md:px-8 lg:grid-cols-[1.02fr_0.98fr] lg:gap-16">
        ...
        <div className="text-center lg:text-left">
          ...
          >
            ...
            easier again. Starts {START_DATE}, live on Zoom, completely free.
          </p>
        ...
        <div>
          ...
          >
            ...
            <div className="px-6 pb-6 pt-3">
              ...
              {/* Where the price used to sit. One word, stated once. NO struck
                  "was" figure beside it: "normally £4.99, now free" is the same
                  value-stacking device the compliance review ruled out, and it
                  would also be a claim about a price this page no longer
                  charges. */}
              ...
              {/* The old line here was a payment-security reassurance — a
                  padlock, and the card wallets Stripe offered. Both are
                  meaningless now, and a padlock on a form that takes no payment
                  reads as boilerplate. Replaced with the thing a reader
                  actually wants to know before clicking: how long it takes. */}
              <p
                className="mt-3 flex items-center justify-center gap-1.5 text-[11.5px] font-medium"
                style={{ color: C.inkMuted }}
              >
                <Timer weight="fill" className="h-3 w-3" />
                Takes under a minute · Three short questions
              </p>
            </div>
          </div>
        </div>
