 ...
 *
 * The watched path is /register — the free stepwise form — not the checkout it
 * replaced. Neither event carries a value or a currency: the challenge is
 * free, so there is no amount to report and a stream of zeroes would only
 * train value-based bidding on nothing.
 *
