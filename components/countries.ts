/**
 * Dialling codes for the registration form's phone field.
 *
 ...
 *
 * The UK sits first and is the default: this is a UK cohort and the sessions
 * are quoted in UK time, so it is the overwhelmingly likely answer.
 */
